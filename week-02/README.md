...
| [`praktikum/diabetes.csv`](praktikum/diabetes.csv) | Dataset [Pima Indians Diabetes](https://www.kaggle.com/datasets/uciml/pima-indians-diabetes-database) (768 baris, 9 kolom) |
